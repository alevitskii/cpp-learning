...
/*
You can't make operator<< virtual because:
1. Only member functions can be virtualized (friend is non-member);
2. Anyway function parameters for Base::operator<< and Derived::operator<< differ (it won't be considered for override).
*/
