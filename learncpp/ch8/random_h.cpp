#include "../libs/random/Random.h" // defines Random::mt, Random::get(), and Random::generate()
...
int main()
{
  ...
  // In cases where we have two arguments with different types and/or if we want the return type to be different than
  // the argument types we must specify the return type using a template type argument (between the angled brackets).
